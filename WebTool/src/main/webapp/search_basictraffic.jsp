		...
		<table width="95%">
			<tr>
				<td width="20%" align="center" valign="top">
					<h2>Search traffic data:</h2> 
					<br>
					<form action="ServletBasicSearch" method=POST>
						...
						<table width="95%" height="100px" frame="box">
							<tr>
								<td width="20%" align="right"><br>
									<p><b>View traffic data from:</b></p></td>
				...
				<br>
				<h3>
					<b>Average traffic intensity: </b><br> <%=request.getParameter("intensity")%> vehicles/hour 
				</h3>
				<br><br>
				<form action="export_basic_results.jsp" method=POST> 
				...
				<br><br>
				<form action="http://localhost:8080/ProjectTFM/search_basictraffic.jsp" method="POST">
