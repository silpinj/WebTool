...
<table width="60%" border=1 align="center">
	...
	csv = new File("./WebTool/src/main/webapp/Basic-Results.csv");
	}
	if(request.getParameter("advanced")!=null && request.getParameter("advanced").equals("1")) {
	csv = new File("./WebTool/src/main/webapp/Advanced-Results.csv");
	}
	if(request.getParameter("covid")!=null && request.getParameter("covid").equals("1")) {
	csv = new File("./WebTool/src/main/webapp/Covid-Results.csv");
	}
	if(csv != null) {
...
<script type=text/javascript>
	...
	function downloadCSVBasic() {
		downloadURI("http://localhost:8080/WebTool/Basic-Results.csv","Basic-Results.csv");
	}
	function downloadCSVAdvanced() {
		downloadURI("http://localhost:8080/WebTool/Advanced-Results.csv","Advanced-Results.csv");
	}
	function downloadCSVCovid() {
		downloadURI("http://localhost:8080/WebTool/Covid-Results.csv","Covid-Results.csv");
	}
