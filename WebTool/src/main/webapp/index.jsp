	...
	<center>
		...
		<table width="50%" border="1">
			...
			<td width="25%" align="center">
				<form action="http://localhost:8080/ProjectTFM/map_measuringpoints.jsp">
			...
			<tr>
			<td width="25%" align="center">
				<form action="http://localhost:8080/ProjectTFM/search_basictraffic.jsp">
			...
			<tr>
			<td width="25%" align="center">
				<form action="http://localhost:8080/ProjectTFM/search_advancedtraffic.jsp">
			...
			<tr>
			<td width="25%" align="center">
				<form action="http://localhost:8080/ProjectTFM/search_covid_traffic.jsp">
